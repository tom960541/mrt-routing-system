...
# 系統設定與地圖資料庫 (綁定計價策略)
# ==========================================
API_KEY = "AIzaSyAxDkIOX4d6Ve3pXPGAQtfT33NsKo4Gg7w" # 部署前記得改用 st.secrets!
...
MAP_DATABASE = {
    "高雄捷運": {
        "json": "krt_data.json", 
        "img": "krt_map.jpg",
        "fare_func": krt_fare_strategy  # 注入策略
    },
    "台北捷運": {
        "json": "tpi_data.json", 
        "img": "TaipeiMetroStamp.png",
        "fare_func": tpi_fare_strategy  # 注入策略
    }
}
